...
The assessment will be separated into two sections. The first section involves
each candidate working through a series of pre-prescribed tasks independently.
...
processing tasks using a dataset that is reflective of the type of data that
the Data Analyst role would be expected to work with on a daily basis. We
encourage candiates to attempt all of the tasks, even if they are not able to
provide a complete solution for all tasks within the time allocated. The
follow-up discussion will provide an opportunity to discuss the candidate's
